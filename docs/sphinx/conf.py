...
latex_documents = [
    #(master_doc, 'pagmo.tex', 'pagmo documentation',
    # 'pagmo development team', 'manual'),
]
...
man_pages = [
    (master_doc, 'BSTools', 'BSTools documentation',
     [author], 1)
]
...
texinfo_documents = [
    #(master_doc, 'pagmo', 'pagmo documentation',
    # author, 'pagmo', 'One line description of project.',
    # 'Miscellaneous'),
]
